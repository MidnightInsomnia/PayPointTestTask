...
### Затраченое время: 2 ночи, примерно 12-14 часов. Основное количество времени ушло на поиск информации, тк я начал примерно представлять как работает блокчейн только в четверг вечером.
